...
var outletUUID = uuid.generate('hap-nodejs:accessories:Color LED');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var outlet = exports.accessory = new Accessory('Color LED', outletUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
outlet.username = "1A:CB:3C:4D:FD:FE";
...
outlet
    ...
    .setCharacteristic(Characteristic.SerialNumber, "C1S2NASF88EW");
...
outlet
    .addService(Service.Outlet, "Color LED") // services exposed to the user should have "names" like "Fake Light" for us
